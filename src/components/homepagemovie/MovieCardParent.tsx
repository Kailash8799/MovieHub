...
const MovieCardParent = ({ navigation, categoryname, categorytitle }: { navigation: any, categoryname: any, categorytitle: any }) => {
    return (
        <View>
            <View style={styles.movietitle}>
                <Text style={styles.text} >{categorytitle}</Text>
                <TouchableOpacity onPress={() => {
                    navigation.navigate('movies', { categoryname: categoryname, categorytitle });
                }} >
