...
const MovieDetailsScreen = ({
  ...
  const desc =
    'Venom: The Last Dance is an upcoming American superhero film featuring the Marvel Comics character Venom, produced by Columbia Pictures in association with Marvel, and distributed by Sony Pictures Releasing';
      ...
      <Animated.ScrollView
        ...
        <View style={styles.bg}>
          ...
          <View style={styles.bottombox}>
            ...
            <TouchableOpacity
              activeOpacity={0.6}
              style={[styles.button, styles.tolistbutton]}>
              <Icon
                name="cloud-download"
          ...
          <View style={[styles.margin, styles.viewmoreflex]}>
            <TouchableOpacity activeOpacity={0.5}>
              <Text style={styles.viewmorecolor}>View more</Text>
            </TouchableOpacity>
          </View>
